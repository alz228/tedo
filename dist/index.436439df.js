...
const getResponse = async function(id, visibility) {
    try {
        await _modelJs.loadData(id);
        _viewJsDefault.default.render(_modelJs.state.person, visibility);
    } catch (err) {
        alert(err);
    }
};
...
getResponse(2, '');
getResponse(3, '');
_viewJsDefault.default.fillList(12);
...
},{"./model.js":"6Yfb5","./view.js":"7k9Oe","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"6Yfb5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class View {
    ...
    fillList(el) {
        for(let i = 0; i < el; i++)this.#selectList.insertAdjacentHTML("beforeend", `<option>${i + 1}</option>`);
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["drOo7","jKMjS"], "jKMjS", "parcelRequire38c5")
